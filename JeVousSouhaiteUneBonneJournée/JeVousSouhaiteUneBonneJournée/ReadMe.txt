========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet JeVousSouhaiteUneBonneJournée
========================================================================

AppWizard a créé cette application JeVousSouhaiteUneBonneJournée pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application JeVousSouhaiteUneBonneJournée.


JeVousSouhaiteUneBonneJournée.vcxproj
...
JeVousSouhaiteUneBonneJournée.vcxproj.filters
...
JeVousSouhaiteUneBonneJournée.cpp
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) JeVousSouhaiteUneBonneJournée.pch et un fichier de type précompilé nommé StdAfx.obj.
